...
import { FaEdit, FaTrash, FaSearch, FaUser, FaChevronLeft, FaChevronRight } from "react-icons/fa";
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="flex items-center gap-3 mb-3">
            <FaUser className="text-red-500 w-8 h-8" />
            <span className="text-sm font-semibold text-red-600 uppercase tracking-wider">Administration</span>
          </div>
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900">Donors</h1>
              <p className="text-gray-600 mt-2">Manage all registered blood donors</p>
            </div>
          </div>
        </motion.div>
        ...
        >
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3 bg-white border border-gray-200 rounded-lg text-gray-900 placeholder-gray-500 focus:outline-none focus:border-red-500 focus:ring-2 focus:ring-red-500/20 transition"
            />
          </div>
        </motion.div>
        ...
        >
          <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
            <p className="text-xs text-gray-600 uppercase font-semibold tracking-wide">Total Donors</p>
            <p className="text-3xl font-bold text-red-600 mt-2">{totalDonors}</p>
          </div>
          <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
        ...
        {!loading && donors.length === 0 && !error && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
          >
            <FaUser className="w-12 h-12 text-blue-500 mx-auto mb-4 opacity-50" />
            <p className="text-blue-900 font-semibold text-lg">
              {search ? "No donors found" : "No donors available"}
            </p>
            <p className="text-blue-700 mt-2">
              {search ? "Try adjusting your search terms" : "Start adding donors to the system"}
            </p>
          </motion.div>
        )}
              ...
              <table className="w-full">
                <thead>
                  <tr className="bg-gradient-to-r from-gray-50 to-gray-100 border-b border-gray-200">
                    ...
                    <th className="px-6 py-4 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Blood</th>
